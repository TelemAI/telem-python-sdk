"""Synchronous Telem client built on :class:`httpx.Client`."""
...
from telem.resources.sessions import SessionsResource


class Telem(BaseClient):
    """Synchronous client for the Telem search orchestration API.
    ...
    def __init__(
        ...
        *,
        ...
        """Create a synchronous Telem client.
    ...
    def search(
        ...
        *,
        ...
        data = self._post("/v1/interactions", body)
    ...
    def providers(self) -> list[ProviderInfo]:
        ...
        """
        data = self._get("/v1/preprocessors")
    ...
    def wrap(
        ...
        *,
        ...
        """Patch an OpenAI client in place so the model can call Telem search as a tool.
        ...
        Args:
            client: An ``openai.OpenAI`` client (duck-typed).
        ...
        """
        from telem.integrations.openai import wrap_openai
